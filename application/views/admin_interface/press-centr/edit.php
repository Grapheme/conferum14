...
<![endif]-->
	...
	<div class="container">
		<div class="row">
			...
			<div class="span9">
				<?php $this->load->view('admin_interface/includes/nav-tab-edit-events');?>
			<?php if($this->input->get('mode') == 'text' && $this->input->get('id') !== FALSE):?>
				<?php $this->load->view('admin_interface/forms/manage-press-centr/edit');?>
			<?php elseif($this->input->get('mode') == 'images' && $this->input->get('id') !== FALSE):?>
				<?php $this->load->view('admin_interface/forms/manage-press-centr/images');?>
			<?php elseif($this->input->get('mode') == 'captions' && $this->input->get('id') !== FALSE):?>
				<?php $this->load->view('admin_interface/forms/manage-press-centr/captions');?>
			<?php endif;?>
			</div>
		</div>
	</div>
...
<?php elseif($this->input->get('mode')=='images'):?>
