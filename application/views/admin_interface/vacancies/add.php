		...
		<div class="row">
			...
			<div class="span9">
				<ul class="breadcrumb">
					...
					<li><a href="<?=site_url(ADMIN_START_PAGE.'/vacancies');?>">Вакансии</a> <span class="divider">/</span></li>
					<li class="active">Добавление вакансии</li>
				</ul>
				<div class="clear"></div>
				<?php $this->load->view('admin_interface/forms/manage-vacancies/add');?>
			</div>
		</div>
	</div>
