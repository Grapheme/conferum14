<?=form_open(ADMIN_START_PAGE.'/reviews/insert',array('class'=>'form-manage-reviews')); ?>
	<div class="control-group">
		<label>Имя: <em>(обязательное)</em></label>
		<input type="text" name="name" class="span3 valid-required" value="" placeholder="" />
		<label>Город:</label>
		<input type="text" name="city" class="span3" value="" placeholder="" />
