		...
		<div class="row">
			...
			<div class="span9">
				<ul class="breadcrumb">
					...
					<li><a href="<?=site_url(ADMIN_START_PAGE.'/where2buy');?>">Адреса где можно купить</a> <span class="divider">/</span></li>
					<li class="active">Редактирование адреса где можно купить</li>
				</ul>
				<div class="clear"></div>
				<?php $this->load->view('admin_interface/forms/manage-where2buy/edit');?>
			</div>
		</div>
	</div>
